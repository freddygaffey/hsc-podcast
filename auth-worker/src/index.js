...
// "hsc" is the unified app's sync channel; its blob already namespaces data per subject
// (subject:epId), so one channel covers every subject. Legacy se/phy channels stay.
const SUBJECTS = new Set(["hsc", "se", "phy"]);

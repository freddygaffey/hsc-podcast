---
title: "Supplementary Materials — Stellar Nucleosynthesis — We Are Made of Stars"
kind: case-study
script: script.md
---
...
|----------------|------------------|--------|-----------------|
| O / B | 10 000 – 50 000 | Blue | CNO cycle |
| A / F | 6 000 – 10 000 | Blue-white / white | CNO ↔ pp transition |
...
| Initial mass | Path after the main sequence |
|--------------|------------------------------|
| ~1 solar mass (Sun) | Red giant → He burning (triple-alpha) → planetary nebula → white dwarf (C/O core, no fusion) → cools to black dwarf |
...
| Quantity | Value |
|----------|-------|
| Big Bang nucleosynthesis output (by mass) | ~75% H, ~25% He-4, trace Li-7 |
| Sun core temperature | ~15.7 × 10⁶ K |
| Solar luminosity | 3.828 × 10²⁶ W |
| Hydrogen fused by Sun per second | ~600 million tonnes |
| Mass → energy per second (Sun) | ~4 million tonnes (~4.25 × 10⁹ kg) |
| Energy per pp-chain / CNO cycle | ~26.73 MeV |
| pp-chain temperature sensitivity | ∝ T⁴ |
| CNO cycle temperature sensitivity | ∝ T¹⁷ |
| CNO dominates above | ~1.3 solar masses |
| Triple-alpha ignition temperature | ~10⁸ K |
| Triple-alpha temperature sensitivity | ∝ T⁴⁰ |
| Hoyle state energy | ~7.6542 MeV above C-12 ground state |
| Binding energy peak (iron-56) | ~8.79 MeV/nucleon |
| Chandrasekhar mass limit | ~1.4 solar masses |
| Sun composition (by number of nuclei) | ~92% H, ~7.8% He, <0.1% C/N/O |
| Min star mass for Type II supernova | ~8 solar masses |
| Remnant: neutron star vs black hole (by core mass) | < ~3 M☉ → neutron star; > ~3 M☉ → black hole |
| Neutron-star density | ~nuclear density (~10¹⁷ kg/m³); diameter ~10 km |
| H burning (25 M☉ star) | ~7 million years |
| He burning (25 M☉ star) | ~700,000 years |
| Carbon burning | ~600 years |
| Neon burning | ~1 year |
| Oxygen burning | ~6 months |
| Silicon burning | ~5 days |
| Core collapse | milliseconds to seconds |

### Listing 8 — Timeline of key people and discoveries

| Year | Person / Event | Contribution |
|------|----------------|--------------|
| 1937–39 | Weizsäcker; Bethe | Propose / develop the CNO cycle |
| 1946 | Fred Hoyle | First major paper: stars as element factories, iron via equilibrium |
| 1949 | Fred Hoyle | Coins "Big Bang" on BBC radio (dismissively) |
| 1953 | Hoyle; Whaling (Caltech) | Predicts and confirms the Hoyle state (carbon resonance) |
| 1957 | Burbidge, Burbidge, Fowler, Hoyle | B²FH paper — 8 processes of stellar nucleosynthesis |
| 1967 | Hans Bethe | Nobel Prize (partly for CNO cycle) |
